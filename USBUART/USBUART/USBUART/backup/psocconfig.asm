...
export LoadConfig_usbuart
export _LoadConfig_usbuart
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_usbuart
	lcall	LoadConfigTBL_usbuart_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration usbuart
;
;    Load configuration registers for usbuart.
...
_LoadConfig_usbuart:
 LoadConfig_usbuart:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_usbuart_Bank0
    mov     X, <LoadConfigTBL_usbuart_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_usbuart_Bank1
    mov     X, <LoadConfigTBL_usbuart_Bank1
