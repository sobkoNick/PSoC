...
export LoadConfigTBL_usbuart_Bank1
export LoadConfigTBL_usbuart_Bank0
export LoadConfigTBL_usbuart_Ordered
AREA lit(rom, rel)
LoadConfigTBL_usbuart_Bank0:
;  Instance name ADC, User Module ADCINC
;       Instance name ADC, Block Name ADC(ASD11)
	db		84h, 90h		;ADC_AtoDcr0(ASD11CR0)
	db		85h, 20h		;ADC_AtoDcr1(ASD11CR1)
	db		86h, 60h		;ADC_AtoDcr2(ASD11CR2)
	db		87h, f8h		;ADC_AtoDcr3(ASD11CR3)
;       Instance name ADC, Block Name PWM(DBB00)
	db		23h, 00h		;ADC_PWMcr0(DBB00CR0)
	db		21h, 00h		;ADC_PWMdr1(DBB00DR1)
	db		22h, 01h		;ADC_PWMdr2(DBB00DR2)
...
;       Instance name DAC8_1, Block Name MSB(ASC10)
	db		80h, a0h		;DAC8_1_MSB_CR0(ASC10CR0)
	db		81h, 41h		;DAC8_1_MSB_CR1(ASC10CR1)
	db		82h, a0h		;DAC8_1_MSB_CR2(ASC10CR2)
	db		83h, 3ch		;DAC8_1_MSB_CR3(ASC10CR3)
...
;  Global Register values Bank 0
	...
	db		63h, 3dh		; AnalogReferenceControl register (ARF_CR)
	...
	db		ffh
LoadConfigTBL_usbuart_Bank1:
;  Instance name ADC, User Module ADCINC
;       Instance name ADC, Block Name ADC(ASD11)
;       Instance name ADC, Block Name PWM(DBB00)
	db		20h, 31h		;ADC_PWMfn(DBB00FN)
	db		21h, 15h		;ADC_PWMsl(DBB00IN)
	db		22h, 40h		;ADC_PWMos(DBB00OU)
;  Instance name DAC8_1, User Module DAC8
;       Instance name DAC8_1, Block Name LSB(ASD20)
;       Instance name DAC8_1, Block Name MSB(ASC10)
;  Instance name USBUART_1, User Module USBUART
