...
USBUART_1_CB_h2d_std_ep_01:
    ...
    mov     [X+USBUART_1_EndpointAPIStatus], NO_EVENT_PENDING
    mov     reg[X + USBUART_1_EP1MODE - 1], USB_MODE_ACK_OUT    ; ACK the endpoint
    JMP     .done
.in:
    mov     [X+USBUART_1_EndpointAPIStatus], EVENT_PENDING
...
USBUART_1_CB_h2d_std_ep_03:
    ...
    mov     [X+USBUART_1_EndpointAPIStatus], NO_EVENT_ALLOWED
...
.cont:
    ...
    XOR     A, FFh
    AND     [USBUART_1_EPDataToggle], A ; Clear the data toggle for this endpoint
    and     [X+USBUART_1_EndpointStatus], ~USB_ENDPOINT_STATUS_HALT    ; Clear any endpoint halts
